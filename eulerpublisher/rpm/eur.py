...
from eulerpublisher.utils.constants import ROOT_DIR

EP_PATH = ROOT_DIR

RESPONSE_SUCCESS = 0
RESPONSE_FAILED = 1
DEFAULT_CONFIG_PATH = os.path.join(EP_PATH, "configs", "copr")
...
class EurOperation():
    def __init__(self) -> None:
        self.client = Client.create_from_config_file(DEFAULT_CONFIG_PATH)
    ...
    def create_build_from_pypi(self,
                              ownername,
                              projectname,
                              pypi_package_name,
    ...
    def create_build_from_rubygems(self,
                              ownername,
                              projectname,
                              gem_name,
                            ):
        try:
            return self.client.build_proxy.create_from_rubygems(
                ownername,
                projectname,
                gem_name,
            ).id
